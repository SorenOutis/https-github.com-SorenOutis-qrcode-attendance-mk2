        ...
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-hidden p-3 sm:p-4 pb-20 md:pb-4">
            ...
            >
                ...
                <div class="max-w-[320px] space-y-2">
                    <h3 class="text-lg font-serif font-bold text-foreground tracking-tight">Quiet on the feedback front</h3>
                    <p class="text-sm text-muted-foreground font-light leading-relaxed">
                        Once guests submit feedback or suggestions from the gateway, their voices will echo here. 
                        {{ from || to ? 'Try clearing your date filters to see all history.' : 'Keep providing great service and the comments will follow!' }}
                    </p>
