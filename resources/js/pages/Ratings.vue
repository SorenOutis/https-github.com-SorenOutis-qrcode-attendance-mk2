                    ...
                    <div class="relative z-10 space-y-2">
                        <div class="flex items-center justify-between gap-2">
                            <div class="min-w-0 flex-1">
                                <p class="text-[10px] md:text-xs font-semibold uppercase tracking-wide text-muted-foreground whitespace-nowrap overflow-hidden text-ellipsis max-w-[8ch] sm:max-w-none">
                                    {{ rating.name || 'Anonymous' }}
                                </p>
                                <p
                                    v-if="rating.email"
                                    class="text-[9px] md:text-[11px] text-muted-foreground/80 whitespace-nowrap overflow-hidden text-ellipsis max-w-[12ch] sm:max-w-none"
                                >
                                    {{ rating.email }}
                                </p>
                            ...
                            <div class="flex items-center gap-0.5">
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            ...
                                            :class="i <= editScore ? 'text-black dark:text-white' : 'text-zinc-300 dark:text-zinc-700'"
                                        >
                                            ★
                                        </span>
                                    </button>
                                ...
                                <template v-else>
                                    <span
                                        ...
                                        :key="i"
                                        class="text-lg transition-colors"
                                        :class="filled ? 'text-black dark:text-white' : 'text-zinc-300 dark:text-zinc-700'"
                                    >
                                        ★
                                    </span>
                                </template>
