...
import { BookOpen, TrendingUp, Users, ArrowRight, ChevronDown } from 'lucide-vue-next';
                ...
                >
                    <div class="flex items-start justify-between mb-4 sm:mb-6">
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="h-10 w-10 sm:h-12 sm:w-12 rounded-xl sm:rounded-2xl bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center border border-zinc-100 dark:border-zinc-800">
                                <BookOpen class="h-5 w-5 sm:h-6 sm:w-6 text-zinc-400" />
                            </div>
                            <div>
